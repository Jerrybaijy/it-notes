...
# jsonData='{"name":"zhangsan","age":18,"hobby":"play"}' #json数据，格式为字符串str
# pythonData=json.loads(jsonData) #Python数据，格式为字典dict
# print(type(pythonData)) #获取到pythonData的格式为dict
# print(pythonData["hobby"]) #获取结果为play
